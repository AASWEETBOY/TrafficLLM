...
def main(
    ...
    logger.warning(
        f"Process rank: {ft_config.training_args.local_rank}, device: {ft_config.training_args.device}, n_gpu: {ft_config.training_args.n_gpu}"
        + f"distributed training: {bool(ft_config.training_args.local_rank != -1)}, 16-bits training: {ft_config.training_args.fp16}"
    )
